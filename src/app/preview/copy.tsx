...
const ja = {
    ...
    hero: {
        ...
        lead: (
            <>
                問い合わせや予約につながるトップページ案を、ヒアリングシートに答えるだけでお作りします。3営業日以内に、PC・スマホ2枚のデザイン案が<span className="nowrap">届きます。</span>気に入らなければ、そこで終わり。費用も、営業も<span className="nowrap">ありません。</span>
            </>
        ),
        chips: [
            { k: "プレビュー費用", v: "0円" },
    ...
    target: {
        ...
        forWho: [
            ...
            "問い合わせや予約の申し込みを、もっと分かりやすい形で受けたい",
