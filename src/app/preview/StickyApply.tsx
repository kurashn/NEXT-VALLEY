...
import { LINE_URL } from "./copy";

const copy: Record<Lang, string> = {
    ja: "LINEで無料プレビューを申し込む",
...
export function StickyApply({ lang = "ja" }: { lang?: Lang }) {
    ...
    return (
        <div
            className={`fixed inset-x-0 bottom-0 z-50 border-t border-line bg-white/95 p-3 backdrop-blur-md transition-transform duration-300 md:hidden ${hidden ? "translate-y-full" : "translate-y-0"}`}
