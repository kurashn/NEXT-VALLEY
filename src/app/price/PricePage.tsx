...
const ja = {
    eyebrow: "PRICE",
    h1: "ホームページ制作の料金",
    lead: "教室・スクールの体験申込を増やすために、Webまわりを整えて、公開してからも改善を続ける仕事をしています。入口になるのは、初期制作費0円・月額8,980円（税込）のホームページ制作・管理です。ご提案とお見積もりまでは無料です。",
    ...
    entryDesc:
        "制作費をいただかず、月額だけでホームページを持てる形です。公開した後の修正・更新も月額に含めているので、体験レッスンの案内や料金の変更も、そのつどご連絡いただければこちらで直します。",
    initialLabel: "初期制作費",
    initialPrice: "0円",
    monthlyLabel: "月額",
    monthlyPrice: "8,980円",
    ...
    growthLead:
        "ホームページができた後、体験申込を増やすための改善を続ける支援です。どこまでお任せいただくかで内容が変わるため、金額はお見積もりでご提示します。",
    growthItems: [
    ...
    onetimeRows: [
        ...
        { k: "hp", name: "ホームページ制作（複数ページ）", price: "¥165,000〜", desc: "教室・お店の顔になるホームページを一式お渡しします" },
