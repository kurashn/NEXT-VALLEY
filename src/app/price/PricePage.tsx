...
const ja = {
    ...
    specs: [
        { k: "制作ページ数", v: "10ページまで" },
        { k: "11ページ目以降", v: "1ページにつき1,000円（税込）を制作時に一度だけ。月額は変わりません。お知らせ・ブログの記事は数えません" },
        { k: "修正・更新", v: "回数の制限なし" },
...
const en: typeof ja = {
    ...
    specs: [
        ...
        { k: "Renewal", v: "Renews automatically after the first year; cancel any month by the end of the previous month" },
        { k: "Billing starts", v: "On the contract date" },
        { k: "Site ownership", v: "Transferable to you after one year or more, at no charge, including the domain" },
    ],
