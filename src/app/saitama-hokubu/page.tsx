...
const areas = [
    ...
    {
        name: "埼玉県内のその他の地域・全国",
        body: "さいたま市・川越市・所沢市など県内全域と、全国どこからでもお受けしています。やり取りはLINEかメールで完結します。",
        link: null,
    },
];
        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="py-16 px-4">
                <div className="max-w-3xl mx-auto space-y-6 text-slate-700 leading-loose">
                    <p>
                        NEXT VALLEY（ネクストバレー）は、本庄市児玉町出身の代表が運営するWeb制作・集客支援です。埼玉を中心に全国のお客様と、やり取りはLINEかメールで進めます。2021年の開業以来、100社以上のホームページ制作とWebマーケティングを支援してきました。
                    </p>
                    <p>
