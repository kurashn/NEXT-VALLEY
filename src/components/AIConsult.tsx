...
もし課題の中心が NEXT VALLEY の支援範囲（Web制作・HP/LP改善・SEO・MEO・SNS・広告・AI活用・業務効率化）の外にある場合は、その部分は範囲外であることを正直に伝えたうえで、範囲内の課題について相談メモを作ってください。

---
ここから下はAIへの指示ではなく、このプロンプトを使うあなたへのご案内です。

できあがった相談メモは、NEXT VALLEY の公式LINE（https://lin.ee/N4QXdJL）にそのまま貼って送れます。無料で改善案と概算のお見積りをお返しします（返答の目安は2営業日以内）。しつこい営業はありません。
