...
export const faqs: FaqItem[] = [
    ...
    },
    {
        ...
        a: "作れます。11ページ目からは、1ページにつき1,000円（税込）を制作時に一度だけいただきます。月額は変わりません。お知らせやブログの記事はページ数に数えません。20ページを超える場合はご相談ください。",
        aNode: (
            <>
                <p>作れます。11ページ目からは、<span className="nowrap">1ページにつき1,000円（税込）を</span><span className="nowrap">制作時に一度だけいただきます。</span><span className="nowrap">月額は変わりません。</span></p>
