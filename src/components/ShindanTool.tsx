    ...
    if (step === -1) {
        return (
            <div className="rounded-[28px] bg-white p-8 text-center shadow-[0_16px_40px_rgba(31,26,20,0.06)] md:p-14">
                <p className="mb-5 text-[13px] font-bold tracking-[0.3em] text-coral-deep">SELF CHECK</p>
                ...
                <p className="lead mx-auto mb-10 max-w-[30em] text-[15px] leading-[2] text-ink-sub">
                    所要時間は約3分。「はい／いいえ」で答えるだけで、スコアと優先的に直すべきポイントを表示します。
                </p>
                <button
                    onClick={() => setStep(0)}
                ...
                <p className="mt-6 text-sm text-ink-sub">登録不要・無料</p>
            </div>
        );
    }
    ...
    if (step >= questions.length) {
        ...
        return (
            <div className="rounded-[28px] bg-white p-8 shadow-[0_16px_40px_rgba(31,26,20,0.06)] md:p-14">
                <p className="mb-6 text-center text-[13px] font-bold tracking-[0.3em] text-coral-deep">RESULT</p>
                ...
                <div className="mb-8 flex flex-col items-center gap-4">
                    <div className="flex h-36 w-36 flex-col items-center justify-center rounded-full border-4 border-coral bg-cream">
                        ...
                        <p className="mt-1 text-sm font-bold text-coral-deep">グレード {tier.grade}</p>
                    </div>
                ...
                {weakCats.length > 0 && (
                    <div className="mb-10">
                        <h3 className="mb-4 text-center text-lg font-bold text-ink">優先的に直すべきポイント</h3>
                        <div className="space-y-3">
                            {weakCats.map((cat, i) => (
                                <div key={cat} className="rounded-2xl bg-cream p-5">
                                    ...
                                    <p className="text-sm leading-[1.9] text-ink-sub">{advice[cat]}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="rounded-2xl bg-navy-deep p-7 text-center md:p-10">
                    ...
                    <p className="mt-4 text-xs text-navy-sub">診断・提案・見積もりは無料／しつこい営業なし</p>
                </div>
        ...
        <div className="rounded-[28px] bg-white p-8 shadow-[0_16px_40px_rgba(31,26,20,0.06)] md:p-14">
            ...
            <div className="mb-8">
                <div className="mb-2 flex items-baseline justify-between">
                    ...
                    <p className="rounded-full bg-cream px-3 py-1 text-xs font-bold text-ink-sub">{q.cat}</p>
                </div>
            ...
            <h2 className="mb-10 min-h-24 text-xl font-bold leading-[1.7] text-ink md:text-2xl">{q.q}</h2>
