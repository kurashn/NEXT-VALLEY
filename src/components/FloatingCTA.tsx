...
export function FloatingCTA() {
    ...
    return (
        <div
            className={`fixed bottom-6 right-6 z-50 flex items-end gap-2 transition-all duration-500 ease-in-out transform ${visible && !closed ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20 pointer-events-none"
                }`}
        >
