...
const ja = {
    ...
    profile: (
        <>
            埼玉県本庄市児玉町の出身です。2020年にプログラミングを独学で始め、制作会社で現場経験を積んだのち、2021年にNEXT VALLEYを開業。以来、100社以上のホームページ制作と集客のお手伝いをしてきました。やり取りはLINEかメールで完結し、埼玉を中心に全国のお客様と<span className="nowrap">進めています。</span></span>
        </>
    ),
    p2: (
        <>
    ...
    p3: (
        <>
            だから私たちは、先に実物をお見せすることにしています。トップページのデザイン案を無料でお作りし、料金と条件をご確認いただいてから決めていただく。気に入らなければ、<span className="nowrap">断ってください。</span>
        </>
    ),
    p4: (
        <>
