...
const ja = {
    ...
    profile: (
        <>
            埼玉県本庄市児玉町の出身です。2020年にプログラミングを独学で始め、制作会社で現場経験を積んだのち、2021年にNEXT VALLEYを開業。以来、100社以上のホームページ制作と集客のお手伝いをしてきました。打ち合わせはオンラインが中心で、埼玉を中心に全国のお客様と<span className="nowrap">進めています。</span>
        </>
    ),
    p2: (
        <>
