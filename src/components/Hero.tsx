...
export default function Hero() {
    return (
        <section className="relative min-h-[110vh] flex items-center justify-center overflow-hidden bg-[#002335]">
            {/* Background Image */}
            ...
            <div className="container relative z-10 mx-auto px-6 text-center">
                ...
                >
                    ...
                    <motion.h1
                        ...
                        className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-white leading-[1.2] mb-8 drop-shadow-xl"
                    >
                        教室の集客、<br />
