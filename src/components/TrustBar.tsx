...
const ja = [
    ...
    { key: "count", value: "100", unit: "社以上", label: "制作・支援実績", note: "代理店経由の案件を含む。", tone: "teal" },
...
const en: typeof ja = [
    ...
    { key: "count", value: "100", unit: "+", label: "Sites built and supported", note: "Including work via agencies.", tone: "teal" },
